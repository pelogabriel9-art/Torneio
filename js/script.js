document.addEventListener('DOMContentLoaded', () => {
    ...
    function resetState() {
        state = {
            ...
            config: {
                ...
                inscricao: 10,
                orgPercent: 20,
                prizePercentages: [50, 30, 20], // Agora é 100% do prêmio
            },
            results: null,
        };
    }
    ...
    function createConfigView() {
        ...
        return createComponent('div', { className: 'view-container bg-white p-6 md:p-8 rounded-xl shadow-lg' }, [
            createComponent('h2', { textContent: 'ALFA APOSTAS - Configurações', className: 'text-2xl font-bold mb-6 text-center' }),
            createComponent('form', { id: 'configForm', className: 'space-y-6' }, [
                ...
                createComponent('div', {}, [
                     ...
                     createComponent('label', { htmlFor: 'orgPercent', textContent: 'Porcentagem para a Org. (%):', className: 'block font-medium mb-1 text-sm' }),
                ...
                createComponent('hr'),
                createComponent('div', {}, [
                    createComponent('h3', { textContent: 'Distribuição dos Prêmios', className: 'text-lg font-semibold mb-2' }),
                    ...prizeInputs,
    ...
    function createResultsView() {
        ...
        return createComponent('div', { className: 'view-container text-center bg-white p-6 rounded-lg shadow-md' }, [
            createComponent('h2', { textContent: '🏆 ALFA APOSTAS - Resultados Finais 🏆', className: 'text-3xl font-bold text-green-600 mb-4' }),
